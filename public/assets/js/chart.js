...
/* Function for adding and updating the data for the bar charts */
...
$(function () {
  ...
  if ($("#browserTrafficChart").length) {
    var doughnutChartCanvas = $("#traffic-chart").get(0).getContext("2d");
    var doughnutChart = new Chart(doughnutChartCanvas, {
      type: "doughnut",
      data: doughnutPieData,
      options: doughnutPieOptions,
  ...
  /* Function to change the data of the bar chart for the dashboard */

  function changeBarData() {
    // console.log ('chala');
    let uri = "/admin/getChartData";
    fetch(uri)
